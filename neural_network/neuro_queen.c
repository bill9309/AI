...
//Rand01 generates a float number between 0 & 1
float Rand01()
{
    long int r;
...
//RandomEqualINT generates a integer between Low & High
...
//Set each input to a random number between 0 & 1
...
//Determines whether each element in the network is 0 or 1 with the output values
